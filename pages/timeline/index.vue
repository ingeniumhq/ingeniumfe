						...
						<div class="row">
							<div class="col-lg-12">
								<div id="page-contents" class="row merged20">
									<div class="col-lg-3">
										<TimelineLeftSidebar></TimelineLeftSidebar>
									</div>
									<div class="col-lg-6">
										<!-- <ul class="filtr-tabs">
													...
													<div class="post-meta">
														...
														<div class="aud-vid">
															<audio id="plyr-audio-player" class="audio-player" controls>
																<!-- <source src="../../../cdn.plyr.io/static/demo/Kishi_Bashi_-_It_All_Began_With_a_Burst.mp3" type="audio/mp3" /> -->
																<!-- <source src="../../../cdn.plyr.io/static/demo/Kishi_Bashi_-_It_All_Began_With_a_Burst.ogg" type="audio/ogg" /> -->
															</audio>
														</div>
